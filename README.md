...
<div><img alt="Logo" src="https://raw.githubusercontent.com/wessberg/@zibuthe7j11/doloribus-odio-quam/master/documentation/asset/@zibuthe7j11/doloribus-odio-quam-logo.png" height="150"   /></div>
...
<a href="https://npmcharts.com/compare/@zibuthe7j11/doloribus-odio-quam?minimal=true"><img alt="Downloads per month" src="https://img.shields.io/npm/dm/@zibuthe7j11/doloribus-odio-quam.svg"    /></a>
<a href="https://www.npmjs.com/package/@zibuthe7j11/doloribus-odio-quam"><img alt="NPM version" src="https://badge.fury.io/js/@zibuthe7j11/doloribus-odio-quam.svg"    /></a>
<img alt="Dependencies" src="https://img.shields.io/librariesio/github/wessberg%2F@zibuthe7j11/doloribus-odio-quam.svg"    />
<a href="https://github.com/zibuthe7j11/doloribus-odio-quam/graphs/contributors"><img alt="Contributors" src="https://img.shields.io/github/contributors/wessberg%2F@zibuthe7j11/doloribus-odio-quam.svg"    /></a>
...
[Become a sponsor/backer](https://github.com/zibuthe7j11/doloribus-odio-quam?sponsor=1) and get your logo listed here.
...
```
$ npm install @zibuthe7j11/doloribus-odio-quam --save-dev
```

### Yarn

```
$ yarn add @zibuthe7j11/doloribus-odio-quam --dev
```

### pnpm

```
$ pnpm add @zibuthe7j11/doloribus-odio-quam --save-dev
```

### Peer Dependencies

`@zibuthe7j11/doloribus-odio-quam` depends on `rollup` and `typescript`, so you need to manually install these as development dependencies as well.
...
```javascript
import ts from "@zibuthe7j11/doloribus-odio-quam";
export default {
	// ...
	plugins: [
		ts({
...
Don't worry if you don't, `@zibuthe7j11/doloribus-odio-quam` will warn you about exactly which dependencies are missing once you run it.
...
<img alt="TSC emitted code" src="https://raw.githubusercontent.com/wessberg/@zibuthe7j11/doloribus-odio-quam/master/documentation/asset/tsc-output-example.png" height="250"   />

Rollup is a bundler, and with it, we can produce clean, small files that are easy to distribute.
With `@zibuthe7j11/doloribus-odio-quam`, declaration files will be bundled, tree-shaken and emitted alongside the chunks emitted by Rollup:

<img alt="Plugin emitted code" src="https://raw.githubusercontent.com/wessberg/@zibuthe7j11/doloribus-odio-quam/master/documentation/asset/plugin-output-example.png" height="250"   />

And, it even works in complex code splitting scenarios:

<img alt="Plugin emitted code with code splitting" src="https://raw.githubusercontent.com/wessberg/@zibuthe7j11/doloribus-odio-quam/master/documentation/asset/plugin-output-example-code-splitting.png" height="250"   />
...
You can use pass a specific TypeScript to use as an option. This may be useful if you are using different TypeScript versions across packages inside a monorepo and you want to use a specific one with `@zibuthe7j11/doloribus-odio-quam`:
...
`@zibuthe7j11/doloribus-odio-quam` provides a few hooks that allow you to hook into and augment the internal behavior of the plugin.
...
The `outputPath` hook can be used to rewrite the location on the filesystem that assets produced by `@zibuthe7j11/doloribus-odio-quam` are written to.
...
Use this property to get hooks into the internals of `@zibuthe7j11/doloribus-odio-quam`.
...
The following is an evolving list of starter templates for new projects using Rollup, TypeScript, and `@zibuthe7j11/doloribus-odio-quam` that you can take a look at and draw inspiration from.

- [Library with CommonJS and ESM output and TypeScript declarations](https://repl.it/@wessberg/@zibuthe7j11/doloribus-odio-quam-library-cjs-esm-declarations-1)
